import './ResetRenterPasswordSuccessful.css'
...
function ResetRenterPasswordSuccessful() {
        ...
        <section className='comp-main-content'>
          <div className='wallet-container wallet-container-successful'>
            ...
            <p className='payment-successful-text'>
              Renter Password reset successful. Please proceed to login with
              your new password
            </p>
...
export default ResetRenterPasswordSuccessful
