import './ChangePasswordLandlord.css'
...
function ChangePasswordLandlord() {
    ...
    <div className='dashboard-container'>
      ...
      <div className='comp-reg-main'>
        ...
        <div className='fund-wallet-header  reset-password-header'>
          <div className='transaction-history-title'>Reset Password</div>
        </div>
...
export default ChangePasswordLandlord
