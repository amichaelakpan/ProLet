...
import '../RenterTransactionHistory/RenterTransactionHistory.css'

function FundRenterWallet() {
  ...
  return (
    <div className='dashboard-container'>
      ...
      <div className='comp-reg-main'>
        ...
        {/* Header Text Section  */}
        <div className='terminate-rent-header fund-renter-header-text'>
...
export default FundRenterWallet
