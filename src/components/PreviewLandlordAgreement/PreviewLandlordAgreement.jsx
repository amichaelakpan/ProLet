...
import './PreviewLandlordAgreement.css'
...
function PreviewLandlordAgreement() {
    ...
    <div className='dashboard-container'>
      ...
      <div className='comp-reg-main'>
        ...
        <section className='comp-get-started'>
          <h1 className='preview-agreement-title'>Preview Agreement</h1>
          <h3>Preview Agreement before sending to client</h3>
        </section>
...
export default PreviewLandlordAgreement
