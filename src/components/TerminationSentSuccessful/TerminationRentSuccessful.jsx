import './TerminationSentSuccessful.css'
...
function TerminationSentSuccessful() {
      ...
      <div className='comp-reg-main'>
        ...
        <section className='comp-main-content'>
          <div className='wallet-container'>
            <h2>Letter of Lease Termination Sent Successfully</h2>
            <p>
              You will get an update from your landlord or agent within the next
              30 minutes or more. Keep an eye on your dashboard notification.
            </p>
            <div>
              <Button
...
export default TerminationSentSuccessful
