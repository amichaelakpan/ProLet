import './ChangePasswordLandlordSuccessful.css'
...
function ChangePasswordLandlordSuccessful() {
        ...
        <section className='comp-main-content'>
          <div className='wallet-container wallet-container-successful'>
            ...
            <p className='payment-successful-text'>
              Password reset successful. Please proceed to login with your new
              password
            </p>
...
export default ChangePasswordLandlordSuccessful
