      ...
      <div className='comp-reg-main'>
        ...
        <section className='comp-main-content'>
          <div className='verify-info-container'>
            <h2>Renter - Verify your information</h2>
            <p className='bvn-prompt-text'>
              Confirm your name and phone number
            </p>
            {/* NIN Verification */}
            <div className='reg-data-div veirfy-details'>
...
export default VerifyRenterInfo
