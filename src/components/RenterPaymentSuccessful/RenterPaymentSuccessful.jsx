import './RenterPaymentSuccessful.css'
...
function RenterPaymentSuccessful() {
        ...
        <section className='comp-main-content'>
          <div className='wallet-container wallet-container-successful'>
            ...
            <p className='payment-successful-text'>
              Your renter wallet has been successfully credited. Please proceed
              to your wallet to see your balance
            </p>
...
export default RenterPaymentSuccessful
