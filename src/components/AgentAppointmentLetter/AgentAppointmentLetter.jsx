...
import './AgentAppointmentLetter.css'
...
function AgentAppointmentLetter() {
    ...
    <div className='dashboard-container'>
      ...
      <div className='comp-reg-main'>
        ...
        <section className='comp-get-started'>
          <h1 className='preview-agreement-title'>Letter of Appointment</h1>
          <h3>
...
export default AgentAppointmentLetter
