    ...
    <div className='dashboard-container'>
      ...
      <div className='comp-reg-main'>
        ...
        <section className='comp-get-started manage-tenants-header-text'>
          <h2>Renter's page</h2>
          <p>
            Page is a dedicated section designed to provide tenants with
            essential information, resources, and tools for a seamless rental
            experience. Here, renters can access lease details, payment options,
            maintenance requests, community guidelines, and other important
            updates. This page ensures that all necessary information is readily
            available, making it easy for tenants to manage their rental
