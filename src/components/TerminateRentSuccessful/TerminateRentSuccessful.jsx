import './TerminateRentSuccessful.css'
...
function TerminateRentSuccessful() {
      ...
      <div className='comp-reg-main'>
        ...
        <section className='comp-main-content'>
          <div className='wallet-container wallet-container-successful'>
            ...
            <p className='payment-successful-text'>Terminate Rent Successful</p>
...
export default TerminateRentSuccessful
