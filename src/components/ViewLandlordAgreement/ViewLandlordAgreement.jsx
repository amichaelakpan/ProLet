...
import './ViewLandlordAgreement.css'
...
function ViewLandlordAgreement() {
    ...
    <div className='dashboard-container'>
      ...
      <div className='comp-reg-main'>
        ...
        <section className='comp-get-started'>
          ...
          <h3>View signed agreement between you and your renter</h3>
        </section>
...
export default ViewLandlordAgreement
