import './PayRenterSuccessful.css'
      ...
      <div className='comp-reg-main'>
        ...
        <section className='comp-main-content'>
          <div className='wallet-container wallet-container-successful'>
            ...
            <p className='payment-successful-text'>Renter Paid Successful</p>
...
export default PayRenterSuccessful
