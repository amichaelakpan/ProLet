import './RenterAgreementList.css'
    ...
    <div className='dashboard-container'>
      ...
      <div className='comp-reg-main'>
        ...
        <section className='comp-get-started manage-tenants-header-text'>
          <h2>Preview Agreement and Sign</h2>
          <p>Preview Agreement and Sign before sending to landlord</p>
        </section>
...
export default RenterAgreementList
